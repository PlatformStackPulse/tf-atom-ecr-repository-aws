# tf-atom-ecr-repository-aws

[![CI](https://github.com/PlatformStackPulse/tf-atom-ecr-repository-aws/actions/workflows/ci.yml/badge.svg)](https://github.com/PlatformStackPulse/tf-atom-ecr-repository-aws/actions/workflows/ci.yml)
![Terraform](https://img.shields.io/badge/terraform-%3E%3D1.6.0-blueviolet)

## Purpose

Terraform atom: AWS ECR Repository - creates a container image repository.
...
| <a name="input_encryption_type"></a> [encryption\_type](#input\_encryption\_type) | Encryption type (AES256 or KMS) | `string` | `null` | no |
...
| <a name="input_image_tag_mutability"></a> [image\_tag\_mutability](#input\_image\_tag\_mutability) | Tag mutability setting (MUTABLE or IMMUTABLE) | `string` | `"IMMUTABLE"` | no |
...
| <a name="input_scan_on_push"></a> [scan\_on\_push](#input\_scan\_on\_push) | Whether to scan images on push | `bool` | `true` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_arn"></a> [arn](#output\_arn) | ARN of the ECR repository |
| <a name="output_enabled"></a> [enabled](#output\_enabled) | Whether the module is enabled |
| <a name="output_registry_id"></a> [registry\_id](#output\_registry\_id) | Registry ID of the ECR repository |
